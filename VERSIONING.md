...
Bedrock releases will always follow the latest Java major version.
If the latest Java version is Pridepack 10.X.Y, the next Bedrock version
is also going to be realeased on 10.X.Y.